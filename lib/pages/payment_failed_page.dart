...
class _PaymentFailedPageState extends State<PaymentFailedPage>
  ...
  Color get _accentColor =>
      widget.isCancelled ? const Color(0xFFF59E0B) : kBrandRed;
                    ...
                    for (int i = 0; i < 3; i++)
                      AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          ...
                          final opacity =
                              (0.12 - i * 0.04) * (_pulse.value - 0.5) * 2;
                      ...
                      child: Transform.scale(
                        ...
                        child: AnimatedBuilder(
                          ...
                          child: Container(
                            ...
                            child: Icon(_icon, color: Colors.white, size: 52),
                          ),
                        ),
                      ),
                    ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  widget.isCancelled ? 'Payment Cancelled' : 'Payment Failed',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _summaryRow('Items', '${widget.itemsCount} item(s)'),
          const SizedBox(height: 8),
          Container(
