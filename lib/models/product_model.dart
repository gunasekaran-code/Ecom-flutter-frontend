class ProductVariation {
  final int id;
  final String type; // 'length', 'size', 'capacity', 'color', 'material', 'dpi'
  final String label; // '5ft', 'XL', '5-stick', 'Green', 'Steel'
  final double price;
  final int stock;
  final bool isAvailable;
  final String? colorHex; // used when type == 'color'
  final String? image; // optional variation-specific image (swaps main carousel)
...
final List<Product> staticProducts = [
  ...
  Product(
    ...
    name: 'Surul Vaal',
    description:
        'High-quality steel practice sword for martial arts training.',
    price: 79.99,
    category: 'weapons',
    categoryId: 1,
    ...
    skuId: 1001,
    variations: [
      ProductVariation(id: 1, type: 'material', label: 'Steel',      price: 79.99, stock: 12, isAvailable: true),
      ProductVariation(id: 2, type: 'material', label: 'Fiberglass', price: 59.99, stock: 8,  isAvailable: true),
      ProductVariation(id: 3, type: 'material', label: 'Aluminum',   price: 69.99, stock: 5,  isAvailable: true),
    ],
  ),
  ...
  Product(
    ...
    skuId: 1002,
    variations: [
      ProductVariation(id: 4, type: 'length', label: '3ft', price: 14.99, stock: 20, isAvailable: true),
      ProductVariation(id: 5, type: 'length', label: '4ft', price: 19.99, stock: 15, isAvailable: true),
      ProductVariation(id: 6, type: 'length', label: '5ft', price: 24.99, stock: 35, isAvailable: true),
      ProductVariation(id: 7, type: 'length', label: '6ft', price: 29.99, stock: 8,  isAvailable: true),
    ],
  ),
  ...
  Product(
    ...
    name: 'Maan Kombu',
    description:
        'Elegant wooden stand for collectibles and training swords.',
    price: 49.99,
    category: 'weapons',
    categoryId: 1,
    imageUrl:
  ...
  Product(
    ...
    variations: [
      ...
      ProductVariation(
        ...
        stock: 12,
        isAvailable: true,
        image: 'https://fashionous.in/cdn/shop/files/Silambam_women_s_Tshirt_mockup.jpg?v=1748004278',
      ),
      ProductVariation(id: 9,  type: 'size', label: 'M',   price: 34.99, stock: 20, isAvailable: true),
      ProductVariation(id: 10, type: 'size', label: 'L',   price: 34.99, stock: 18, isAvailable: true),
      ProductVariation(id: 11, type: 'size', label: 'XL',  price: 36.99, stock: 10, isAvailable: true),
      ProductVariation(id: 12, type: 'size', label: 'XXL', price: 39.99, stock: 5,  isAvailable: true),
    ],
  ),
  ...
  Product(
    ...
    name: 'Yoga Mat',
    description:
        'Non-slip yoga mat with comfortable cushioning and grip.',
    price: 24.99,
    category: 'sports',
    categoryId: 2,
    imageUrl:
  ...
  Product(
    ...
    categoryId: 3,
    imageUrl:
        'https://m.media-amazon.com/images/I/61OA+B6VszL._AC_UY1100_.jpg',
    images: [
      'https://m.media-amazon.com/images/I/61OA+B6VszL._AC_UY1100_.jpg',
    ],
    stock: 15,
    ...
    skuId: 1003,
    variations: [
      ProductVariation(id: 13, type: 'capacity', label: '3-stick', price: 39.99, stock: 10, isAvailable: true),
      ProductVariation(id: 14, type: 'capacity', label: '5-stick', price: 49.99, stock: 15, isAvailable: true),
      ProductVariation(id: 15, type: 'capacity', label: '7-stick', price: 59.99, stock: 6,  isAvailable: true),
    ],
  ),
  ...
  Product(
    ...
    variations: [
      ...
      // ── DPI variations ──
      ProductVariation(id: 25, type: 'dpi', label: '800 DPI',  price: 589.00, stock: 12, isAvailable: true),
      ProductVariation(id: 26, type: 'dpi', label: '1200 DPI', price: 609.00, stock: 24, isAvailable: true),
      ProductVariation(id: 27, type: 'dpi', label: '1600 DPI', price: 649.00, stock: 12, isAvailable: true),
    ],
  ),
];